-- Pred spustenim: stejný Supabase projekt ako v .env (URL + anon key). Po zmene .env: npm run dev znovu.
-- Nespúšťaj len CREATE TABLE – musí dobehnúť GRANT, RLS, politiky a NOTIFY dole.
-- Tabulky circuit_* nekolidujú s LMS `assignments`. Obsah je zhodný s supabase/schema.sql.
